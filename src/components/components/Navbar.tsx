...
export default function Navbar() {
  ...
  return (
    <div className="mx-auto flex w-full  max-w-7xl justify-between bg-white px-4 py-4 text-sm">
      {/* left side  */}
      <section ref={animationParent} className="flex items-center gap-10">
        ...
        <div className="font-mono text-lg font-bold uppercase text-neutral-400">
            ...
            <>
              ...
              <li>
                <button
                  ...
                  className="-mt-1 rounded-full bg-blue-800 p-2 px-5"
                >
                  Гарах
                </button>
              </li>
