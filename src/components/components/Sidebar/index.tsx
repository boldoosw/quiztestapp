...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 rounded px-6 py-5.5 lg:py-6.5">
        <Link href="/">
          <Image
            className="rounded"
            width={64}
            height={64}
            src={"/assets/images/logo_mcu.png"}
            // src={"/images/logo/logo.svg"}
            alt="Logo"
            priority
          />
        </Link>
        <h1 className=" text-bold ml-4 uppercase text-white">
              ...
              <li>
                <Link
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname.includes("lessons") && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/climov_test" && "text-white"
                              }`}
                            >
                              Климовын Тест
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/holland_test"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/holland_test" && "text-white"
                              } `}
                            >
                              Холландын Тест
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/custom_test"
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                pathname === "/custom_test" && "text-white"
                              } `}
                            >
                              MBTI Тест
                            </Link>
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          {!session ? (
                            ...
                            <>
                              ...
                              <li>
                                <button
                                  className="flex items-start gap-3.5 px-6 py-4 text-lg font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
                                  onClick={() => {
                                    signOut();
                                  }}
                                >
